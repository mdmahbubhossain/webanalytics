! function(e) {
    ...
    return function i(u, s, c) {
        ...
        1: [function(e, t, n) {
            var r, o, i = t.exports = {};
            console.warn('%c[DEPRECATION]%c The SDK version you are using is deprecated and unsecure. Please upgrade to SDK v4 or later. For more information, visit https://www.emailjs.com/docs/sdk/installation/', 'color: red; font-weight: bold;', 'color: inherit;');
            ...
            (function(p, m) {
                (function() {
                    (function() {
                        ...
                        }, i.allSettled = t, i.resolve = function(t) {
        ...
        4: [function(e, t, n) {
            ...
            function l(e, t, n, r) {
                ...
                return o.append("lib_version", "2.6.4"), o.append("service_id", e), o.append("template_id", t), o.append("user_id", r || u), a(c + "/api/v1.0/email/send-form", o).then(function(e) {
                    return i.UI.successState(n), e
                }, function(e) {
                    return i.UI.errorState(n), Promise.reject(e)
                })
            }
            n.init = r, n.send = o, n.sendForm = l, n.default = {
                init: r,
                send: o,
                sendForm: l
            }
